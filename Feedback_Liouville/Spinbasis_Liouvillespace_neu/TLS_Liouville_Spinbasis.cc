...
namespace itensor{
    ...
    double TLS_Liouville::full_trace()
    {
    ...
    double TLS_Liouville::full_exc_occ(ITensor psitensor)
    {
        ...
        for (int i=1; i<=ttotal+1; i++)
        {
            ...
            if (s==psi_s)
            {
                ...
                MPOTensor.set(s(4), prime(s(1)), -1.0);
        ...
        double trace = 0.5*TLS_Liouville::full_trace();
        
        return (0.5*occ + trace);
    }
    
    double TLS_Liouville::full_gr_occ(ITensor psitensor)
    {
        Index psi_s = findtype(psitensor, Site);
        MPO MPOOcc = MPO(ttotal+1);
        ITensor MPOTensor;
    ...
    {
        Complex trace_contr = psi_contracted.cplx(bin[0](1),bin[1](1),bin[2](1),bin[3](1));

        return trace_contr.real();
    }
    
    double TLS_Liouville::tr_ex_occ(ITensor psi_contracted)
    {
        Complex temp1 = psi_contracted.cplx(bin[0](1),bin[1](1),bin[2](1),bin[3](1));
        Complex temp2 = psi_contracted.cplx(bin[0](4),bin[1](1),bin[2](1),bin[3](1));
        
        return 0.5*(temp1.real()-temp2.real());
    }
    
    double TLS_Liouville::tr_gr_occ(ITensor psi_contracted)
    {
        Complex temp1 = psi_contracted.cplx(bin[0](1),bin[1](1),bin[2](1),bin[3](1));
        Complex temp2 = psi_contracted.cplx(bin[0](4),bin[1](1),bin[2](1),bin[3](1));
    ...
    void TLS_Liouville::setup_dir_and_filename()
    {
        ...
        fprintf(datastream_timeevo,"#time \tex_occ \tgr_occ \t (ex_occ + gr_occ) \t fulltrace \t singletensortrace \t purity \tcontr_trace \t contr_ex_occ \t contr_gr_occ \t full_ex_occ \t full_gr_occ \n");
    ...
    void TLS_Liouville::set_up_Uevo_without_feedback()
    {
        ...
        PureDephasing.set(bin[0](1), prime(bin[0](1)), 0.5*Kappa*dt);
        PureDephasing.set(bin[0](4), prime(bin[0](1)), -0.5*Kappa*dt);
        PureDephasing.set(bin[0](2), prime(bin[0](2)), -1.0*Kappa*dt);
        PureDephasing.set(bin[0](3), prime(bin[0](3)), -1.0*Kappa*dt);
        PureDephasing.set(bin[0](4), prime(bin[0](4)), 0.5*Kappa*dt);
        PureDephasing.set(bin[0](1), prime(bin[0](4)), -0.5*Kappa*dt);
    ...
    void TLS_Liouville::apply_Uevo_with_feedback(int timestep)
    {
        ...
        fprintf(datastream_timeevo, "%f \t %e \t %e \t %e \t %e \t %e \t %e \t %e \n", (timestep-Nfb)*dt, TLS_Liouville::full_exc_occ(psi.A(timestep+1)), TLS_Liouville::excited_occupation(psi.A(timestep+1)), TLS_Liouville::ground_occupation(psi.A(timestep+1)), (TLS_Liouville::excited_occupation(psi.A(timestep+1))+TLS_Liouville::ground_occupation(psi.A(timestep+1))), TLS_Liouville::full_trace(), TLS_Liouville::single_tensor_trace(psi.A(timestep+1)),  TLS_Liouville::rhosquare(psi.A(timestep+1)));
        
        
        
        if ((timestep%10)==0) 
        {
            printf("time %.3f of %.3f -- occ=%.10f -- trace=%.10f -- purity=%.10f \n", (timestep-Nfb)*dt, t_end*dt, TLS_Liouville::excited_occupation(psi.A(timestep+1)),  TLS_Liouville::full_trace() ,TLS_Liouville::rhosquare(psi.A(timestep+1)));
        }
    ...
    void TLS_Liouville::timeevolve_system_without_feedback()
    {
        ...
        fprintf(datastream_timeevo, "%f \t %e \t %e \t %e \t %e \t %e \t %e \t %e \t %e \t %e \t %e \t %e \n", 0.0, TLS_Liouville::excited_occupation(psi.A(1)), TLS_Liouville::ground_occupation(psi.A(1)), (TLS_Liouville::excited_occupation(psi.A(1))+TLS_Liouville::ground_occupation(psi.A(1))), TLS_Liouville::full_trace(), TLS_Liouville::single_tensor_trace(psi.A(1)), TLS_Liouville::rhosquare(psi.A(1)),TLS_Liouville::trace_contracted(psi_contracted),TLS_Liouville::tr_ex_occ(psi_contracted),TLS_Liouville::tr_gr_occ(psi_contracted), TLS_Liouville::full_exc_occ(psi.A(1)), TLS_Liouville::full_gr_occ(psi.A(1)));
        ...
        for(int j = 0; j<ttotal; j++)
        {
            ...
            fprintf(datastream_timeevo, "%f \t %e \t %e \t %e \t %e \t %e \t %e \t %e \t %e \t %e \t %e \t %e \n", (j+1)*dt, TLS_Liouville::excited_occupation(psi.A(j+2)), TLS_Liouville::ground_occupation(psi.A(j+2)), (TLS_Liouville::excited_occupation(psi.A(j+2))+TLS_Liouville::ground_occupation(psi.A(j+2))), TLS_Liouville::full_trace(), TLS_Liouville::single_tensor_trace(psi.A(j+2)), TLS_Liouville::rhosquare(psi.A(j+2)),TLS_Liouville::trace_contracted(psi_contracted),TLS_Liouville::tr_ex_occ(psi_contracted),TLS_Liouville::tr_gr_occ(psi_contracted), TLS_Liouville::full_exc_occ(psi.A(j+2)), TLS_Liouville::full_gr_occ(psi.A(j+2)));
            if ((j%10)==0) 
            {
                printf("time %.3f -- ex occ=%.3f -- gr occ=%.3f -- (ex occ+gr occ=%.3f)  -- trace=%.3f -- purity=%.3f \n", (j+1)*dt, TLS_Liouville::excited_occupation(psi.A(j+2)), TLS_Liouville::ground_occupation(psi.A(j+2)), (TLS_Liouville::excited_occupation(psi.A(j+2))+TLS_Liouville::ground_occupation(psi.A(j+2))), TLS_Liouville::full_trace(), TLS_Liouville::rhosquare(psi.A(j+2)));
            }
        }
        fclose(datastream_timeevo);
    }
    ...
    void TLS_Liouville::timeevolve_system_with_feedback()
    {
        ...
        printf("time %.3f of %.3f -- occ=%.10f -- trace=%.10f -- purity=%.10f \n", 0.0*dt, t_end*dt, TLS_Liouville::excited_occupation(psi.A(1)),  TLS_Liouville::full_trace() ,TLS_Liouville::rhosquare(psi.A(1)));
